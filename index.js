...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>This is the Default Page of the Server. If You have not specified anything or a Address, this new page should be visible.</p></body></html>');
        res.end();
